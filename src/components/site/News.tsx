...
export const NEWS = [
  ...
  },
  {
    date: '2 июля 2026',
    tag: 'Каталог',
    title: 'Новая подборка шаблонов для лендингов',
    text: 'Добавили 12 адаптивных шаблонов лендингов под разные ниши — от услуг до интернет-магазинов. Все с чистой вёрсткой.',
    icon: 'LayoutTemplate',
  },
  {
    date: '25 июня 2026',
    tag: 'Сервис',
    title: 'Ускорили выдачу ссылок на скачивание',
    text: 'Оптимизировали процесс обработки платежей — теперь ссылка на архив приходит на почту ещё быстрее после оплаты.',
    icon: 'Zap',
  },
  {
    date: '15 июня 2026',
    tag: 'Поддержка',
    title: 'Расширили службу поддержки',
    text: 'Увеличили штат специалистов поддержки — теперь ответ на вопрос по установке или доработке скрипта приходит быстрее.',
    icon: 'Headphones',
  },
];
