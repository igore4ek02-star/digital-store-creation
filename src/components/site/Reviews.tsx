...
export const REVIEWS = [
  ...
  },
  {
    ...
    text: 'Взяла готовый проект каталога товаров с корзиной. Всё завелось без танцев с бубном, менеджер помог с первой настройкой.',
    rating: 5,
  },
  {
    name: 'Павел Н.',
    role: 'Frontend-разработчик',
    text: 'Шаблон админ-панели пригодился сразу в трёх проектах. Вёрстка аккуратная, компоненты переиспользуемые.',
    rating: 4,
  },
  {
    name: 'Екатерина Ж.',
    role: 'Маркетолог',
    text: 'Купила скрипт лендинга для акции — запустили за день. Отдельное спасибо, что не пришлось ничего дорабатывать под мобильные.',
    rating: 5,
  },
  {
    name: 'Игорь Б.',
    role: 'Системный администратор',
    text: 'Заказывал установку под ключ на свой хостинг. Специалисты разобрались быстро, объяснили что и как настроено.',
    rating: 5,
  },
];
